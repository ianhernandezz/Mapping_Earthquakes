...
// We create the tile layer that will be the background of our map (SATELLITE).
...
// link to airport GeoJSON earthquake data
...
d3.json(earthquakeData).then(function (data) {
  ...
  d3.json("https:raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function (techtonicData) {
    ...
    // Add the tectonic late group to the map
